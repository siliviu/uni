...
class ServiceTestEvent(unittest.TestCase):
    def test_service(self):
        ...
        self.assertEqual(book_ctrl.get_book(1).copies, 0)
        self.assertEqual(book_ctrl.get_book(1).borrowers, 1)
        self.assertEqual(client_ctrl.get_client(1).borrowed, 1)
        event_ctrl.return_book(1)
        self.assertEqual(book_ctrl.get_book(1).copies, 1)
        self.assertEqual(book_ctrl.get_book(1).borrowers, 0)
