                ...
                if name == 'book':
                    ...
                    if args[0] in ('print', 'list'):
                        ...
                        self.__book_ctrl.modify_book(
                            int(args[1]),
                            options[args[2]],
                            args[3] if args[2] in ('title', 'copies') else int(args[3]))
                    ...
                    if args[0] in ('print', 'list'):
                        ...
                        self.__client_ctrl.modify_client(
                            int(args[1]),
                            options[args[2]],
                            args[3] if args[2] == 'name' else int(args[3]))
                    ...
                    Menu.print_results(
                        ...
                        else self.__client_ctrl.get_20th_percentile())
                elif name == 'exit':
