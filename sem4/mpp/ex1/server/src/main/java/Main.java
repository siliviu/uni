...
//		WordsRepository wordsRepository = new WordsHibernateRepository();
		ConfigurationRepo configurationRepo = new ConfigurationHibernateRepo();
		MoveRepository moveRepository = new MoveHibernateRepository();
		LoginService loginService = new LoginService(userRepository);
		IMasterService service = new MasterService(loginService, gameRepository, configurationRepo, moveRepository);
