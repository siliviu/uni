...
public class ChildHibernateDBRepository implements ChildRepository {
	private static final Logger logger = LogManager.getLogger(ChildHibernateDBRepository.class.getName());
