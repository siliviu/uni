...
public class SignupHibernateDBRepository implements SignupRepository {
	private static final Logger logger = LogManager.getLogger(SignupHibernateDBRepository.class.getName());
	@Override
