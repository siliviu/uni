...
public class SignupClient {
	...
	public static final String URL = "http://localhost:8080/competition/signups";
	...
	public Signup[] get() throws RuntimeException {
		return execute(() -> restClient.get().uri(URL).retrieve().body(Signup[].class));
	}
