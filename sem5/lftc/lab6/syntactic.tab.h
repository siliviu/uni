...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    LEFT_BRACE = 265,              /* LEFT_BRACE  */
    RIGHT_BRACE = 266,             /* RIGHT_BRACE  */
    LEFT_BRACKET = 267,            /* LEFT_BRACKET  */
    RIGHT_BRACKET = 268,           /* RIGHT_BRACKET  */
    HASH = 269,                    /* HASH  */
    INCLUDE = 270,                 /* INCLUDE  */
    IOSTREAM = 271,                /* IOSTREAM  */
    USING = 272,                   /* USING  */
    ...
    INPUT = 277,                   /* INPUT  */
    OUTPUT = 278,                  /* OUTPUT  */
    INPUT_OPERATOR = 279,          /* INPUT_OPERATOR  */
    OUTPUT_OPERATOR = 280          /* OUTPUT_OPERATOR  */
  };
